...
const menuDataAlmaty = {
  ...
  party: {
    ...
    icon: 'fa-users',
    items: [
      { id: 30, name: { ru: '«Сый табақ» (5-6)', kk: 'Syı tabaq (5-6)', en: '"Syy Tabak" (5-6)' }, price: 75990, priceWithoutHead: 65990, hasToggle: true, image: 'syy-tabak.jpg', category: 'party', desc: { ru: 'С головой / Без головы', kk: 'Qoy basymen / Basyz', en: 'With / Without head' }, preorder: { ru: '🔴 Предзаказ за 2-3 дня', kk: '🔴 Aldın ala tapsyrys 2-3 kún', en: '🔴 Pre-order 2-3 days' }, info: { ru: 'На 5-6 персон', kk: '5-6 adamǵa', en: 'For 5-6 persons' } },
      { id: 31, name: { ru: '«Той табақ» (5-6)', kk: 'Toı tabaq (5-6)', en: '"Toy Tabak" (5-6)' }, price: 75990, priceWithoutHead: 65990, hasToggle: true, image: 'toy-tabak.jpg', category: 'party', desc: { ru: 'С головой / Без головы', kk: 'Qoy basymen / Basyz', en: 'With / Without head' }, preorder: { ru: '🟡 Заказ за 1 день', kk: '🟡 Tapsyrys 1 kún', en: '🟡 Order 1 day' }, info: { ru: 'На 5-6 персон', kk: '5-6 adamǵa', en: 'For 5-6 persons' } },
